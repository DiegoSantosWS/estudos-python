...
token = "EAAeOvCXhgk8BAAdZBPk8yGHtQ4yrPEkDgHgVene48fjA0ZBBpXobcgSHbrz81KkoNjZBjZCybBTAxGYt1S8JReUaoJZBnRoZCuJXXViELpIErVcZBy8mLca2WUblvIPF8AZBXaHpqEgAjBQDHSZBB0H2fKpfpACi9r7ZAezlvGphMnMQZDZD"
app = Flask(__name__)
...
def webhook():
    if request.method == 'POST':
        ...
        if request.args.get('hub.verify_token') == 'teste@123Sasas':
